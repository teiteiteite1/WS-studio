    ...
    <main>
      ...
      <section className="content-section news-section" id="news">
        ...
        <div className="news-list">
          ...
          <article>
            <time dateTime="2026-08-06">2026.8.6</time>
            <p>AI音楽コンピレーションアルバム「<a href="https://wsstudiotei.base.shop/items/152969255" target="_blank" rel="noreferrer">Now Generating</a>」発売</p>
          </article>
          <article>
          ...
          <article><time dateTime="2026-07-15">2026.7.15</time><p>OFFICIAL SITE 開設</p></article>
