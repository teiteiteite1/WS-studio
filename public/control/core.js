...
function scenarioContext(c){const bible=c.id==='shafuchan'?state.bible:null;return{name:c.name,personality:c.personality,speaking_style:c.speaking,likes_dislikes:c.likes,notes:c.notes,world:bible?.home||c.world,recurring_places:bible?.places||c.places,...(bible?{series_premise:bible.premise,canon_timeline:bible.timeline,relationships:bible.relationships,recurring_props:bible.recurringProps,canon_episodes:bible.canon,continuity_rules:bible.continuity,visual_rules:bible.visualRules,story_rules:bible.storyRules,never_do:bible.neverDo,open_threads:bible.openThreads}:{})}}
